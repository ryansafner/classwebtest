...
The following book is **required**^[Actually, I **strongly recommend** it. You are not *obligated* to buy it, in the sense that you will still have access to the data and homework without possessing the book. But this is a course where you really will want to understand the derivations or get additional context beyond just my slides...] and will be available from the campus bookstore.
